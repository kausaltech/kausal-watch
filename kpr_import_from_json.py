...
transitions_category_type_data = {
    'name': "Omställningar",
    'usable_for_actions': True,
    'hide_category_identifiers': True,
}
transitions_category_type, _ = CategoryType.objects.update_or_create(
    plan=plan,
    identifier='transition',
    defaults=transitions_category_type_data,
)
metadata, _ = CategoryTypeMetadata.objects.update_or_create(
    type=transitions_category_type,
    identifier='impact',
    defaults=dict(
...
action_types = {
    'administration': 'Administrativ åtgärd',
    'commitment': 'Åtagande',
    'financial': 'Ekonomisk åtgärd',
    'information': 'Informativ åtgär',
    'policy': 'Styrmedel',
    'research-development': 'Forskning och utveckling',
}

# Create action type categories and fetch icons
for identifier, name in action_types.items():
    category, _ = Category.objects.update_or_create(
        type=action_types_category_type,
    ...
    url = f'https://app.climateview.global/assets/images/action-types/{identifier}.svg'
