...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='actionlistpage',
            name='details_aside',
            field=wagtail.fields.StreamField([('attribute', actions.blocks.ActionAttributeTypeChooserBlock(label='Attribute', required=True)), ('categories', actions.blocks.CategoryTypeChooserBlock(label='Category', required=True)), ('schedule', actions.blocks.generated.ActionScheduleBlock()), ('contact_persons', actions.blocks.generated.ActionContactPersonsBlock()), ('responsible_parties', actions.blocks.action_content.ActionResponsiblePartiesBlock())], blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='actionlistpage',
            name='details_main_bottom',
            field=wagtail.fields.StreamField([('attribute', actions.blocks.ActionAttributeTypeChooserBlock(label='Attribute', required=True)), ('categories', actions.blocks.CategoryTypeChooserBlock(label='Category', required=True)), ('lead_paragraph', actions.blocks.generated.ActionLeadParagraphBlock()), ('description', actions.blocks.generated.ActionDescriptionBlock()), ('official_name', actions.blocks.action_content.ActionOfficialNameBlock()), ('links', actions.blocks.generated.ActionLinksBlock()), ('tasks', actions.blocks.generated.ActionTasksBlock()), ('merged_actions', actions.blocks.generated.ActionMergedActionsBlock()), ('related_actions', actions.blocks.generated.ActionRelatedActionsBlock()), ('related_indicators', actions.blocks.generated.ActionRelatedIndicatorsBlock())], blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='actionlistpage',
