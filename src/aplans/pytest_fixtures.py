"""Fixtures shared by Watch and its separately installed extension tests."""
...
register(actions_factories.ActionTaskContactFactory, 'action_task_contact')
register(actions_factories.ActionTaskResponsiblePartyFactory)
