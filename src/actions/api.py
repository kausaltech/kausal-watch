...
class ActionTaskSerializer(I18nFieldPlanLanguagesSerializerMixin[ActionTask], serializers.ModelSerializer[ActionTask]):
    ...
    # identify nothing, since those models have no endpoint of their own. Assignments are read-only here;
    # writing them through the bulk serializer is not supported (see the P-2081 plan, section 5.4).
