...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='actionlistpage',
            name='details_aside',
            field=wagtail.fields.StreamField([('attribute', actions.blocks.ActionAttributeTypeChooserBlock(label='Attribute', required=True)), ('categories', actions.blocks.CategoryTypeChooserBlock(label='Category', required=True)), ('schedule', actions.blocks.action_content.ActionScheduleBlock()), ('contact_persons', actions.blocks.action_content.ActionContactPersonsBlock()), ('responsible_parties', actions.blocks.action_content.ActionResponsiblePartiesBlock())], blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='actionlistpage',
            name='details_main_bottom',
            field=wagtail.fields.StreamField([('attribute', actions.blocks.ActionAttributeTypeChooserBlock(label='Attribute', required=True)), ('categories', actions.blocks.CategoryTypeChooserBlock(label='Category', required=True)), ('lead_paragraph', actions.blocks.action_content.ActionLeadParagraphBlock()), ('description', actions.blocks.action_content.ActionDescriptionBlock()), ('official_name', actions.blocks.action_content.ActionOfficialNameBlock()), ('links', actions.blocks.action_content.ActionLinksBlock()), ('tasks', actions.blocks.action_content.ActionTasksBlock()), ('merged_actions', actions.blocks.action_content.ActionMergedActionsBlock()), ('related_actions', actions.blocks.action_content.ActionRelatedActionsBlock()), ('related_indicators', actions.blocks.action_content.ActionRelatedIndicatorsBlock())], blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='actionlistpage',
