    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_language', models.CharField(choices=[('fi', 'Finnish'), ('en', 'English'), ('sv', 'Swedish')], default=aplans.fields.get_default_language, max_length=8)),
                ('other_languages', aplans.utils.ChoiceArrayField(base_field=models.CharField(choices=[('fi', 'Finnish'), ('en', 'English'), ('sv', 'Swedish')], default=aplans.fields.get_default_language, max_length=8), blank=True, default=list, null=True, size=None)),
