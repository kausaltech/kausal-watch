    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, max_length=16, null=True, validators=[aplans.utils.validate_css_color], verbose_name='color')),
                ('i18n', modeltrans.fields.TranslationField(fields=('name',), required_languages=(), virtual_fields=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_language', models.CharField(choices=[('fi', 'Finnish'), ('en', 'English'), ('sv', 'Swedish')], default=actions.models.plan.get_default_language, max_length=8)),
                ('other_languages', aplans.utils.ChoiceArrayField(base_field=models.CharField(choices=[('fi', 'Finnish'), ('en', 'English'), ('sv', 'Swedish')], default=actions.models.plan.get_default_language, max_length=8), blank=True, default=list, null=True, size=None)),
